...
FIND_TARGET_BLOCK_PIXEL_AREA_FOUND = 12
FIND_TARGET_BLOCK_TURN_DEGREES = 6
FIND_TARGET_BLOCK_SLEEP_SECONDS = 1.0

FIND_ANY_BLOCKS_PIXEL_AREA_CLOSE = 3500
...
LOCALIZE_TARGET_BLOCK_PIXEL_AREA_POSITIONED = [
    11750,
    11250,
    11900,
]
...
LOCALIZE_TARGET_BLOCK_SLOW_TRANSLATION_TIMEOUT_SECONDS = 9.0
...
GET_TO_DROP_POINT_MIN_EST_X_CM = 30
GET_TO_DROP_POINT_MIN_EST_Y_CM = 245

RELATIVE_ORIENTATION_TO_FACE_OPPOSITE_WALL = 90.0
RELATIVE_ORIENTATION_TO_FACE_ADJACENT_WALL = 165.0
RELATIVE_ORIENTATION_TO_FACE_AFTER_DROP_POINT = 235.0
...
THRESHOLD_HSV_GREEN_MIN = ( 45,  45,  85)
THRESHOLD_HSV_GREEN_MAX = (100, 160, 220)
THRESHOLD_HSV_BLUE_MIN  = (100,  50,  75)
THRESHOLD_HSV_BLUE_MAX  = (140, 255, 255)
THRESHOLD_HSV_YLW_MIN   = ( 25,  60, 185)
THRESHOLD_HSV_YLW_MAX   = ( 50, 120, 225)
THRESHOLD_HSV_BLACK_MIN = ( 21,   0,  49)
THRESHOLD_HSV_BLACK_MAX = (116,  46,  89)
